...
const Staff = () => {
  ...
  const capturePhoto = () => {
    ...
    canvas.toBlob((blob) => {
      setPhoto(new File([blob], "staff.jpg", { type: "image/jpeg" }));
  ...
  const resetForm = () => {
    setFormData({ name: "", phoneNumber: "", email: "", department: "" });
    setPhoto(null);
  ...
  if (submitted) {
    return (
      <div className="page-container">
        <div className="success-message">Staff registered successfully!</div>
      </div>
    );
  }
